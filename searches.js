const searches = {
  ...
  gpn: { name: 'GP Notebook', url: 'https://www.gpnotebook.co.uk/simpleprocess.cfm?querystring='},
  ...
  puk: { name: 'Patient.info (PatientUK)', url: 'https://patient.info/search.asp?searchterm='},
